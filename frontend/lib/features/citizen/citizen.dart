...
/// - Dashboard with emergency type selection
/// - Active incident tracking with live timeline
...
export 'presentation/citizen_active_incident_screen.dart';
export 'presentation/citizen_profile_screen.dart';
export 'presentation/citizen_reports_screen.dart';
